...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/YZ_4MuFS_DPS_fragment_Yfirst_Zsecond.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:YZ_4MuFS_DPS_GEN_2016UL.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'Bottomonium:all = onSecondHard:generate = on', 
