...
#       'Bottomonium:qqbar2bbbar(3S1)[3PJ(8)]g = on,off,off',
        ...
        'Bottomonium:all = on' #Again, question if we want to do this or use the long list from above, doing this will include the chi b states 
       ...
       'SecondHard:WeakZ0 = on', #I'm guessing the syntax here...
