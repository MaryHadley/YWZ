...
//   edm::EDGetTokenT<edm::MergeableCounter> nTotalToken_; // need for EventCountProducer //comment out if !applyZmuonFilter
//   edm::EDGetTokenT<edm::MergeableCounter> nFilteredToken_; //need for EventCountProducer //comment out if !applyZmuonFilter
...
//   nTotalToken_ = consumes<edm::MergeableCounter, // for EventCountProducer //comment out if !applyZmuonFilter
//   edm::InLumi>(edm::InputTag("nEventsTotal")); //for EventCountProducer //comment out if !applyZmuonFilter
   
//  nFilteredToken_ = consumes<edm::MergeableCounter, // for EventCountProducer //comment out if !applyZmuonFilter
