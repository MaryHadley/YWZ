...
# with command line options: Configuration/GenProduction/python/YZ_4MuFS_DPS_fragment_Yfirst_Zsecond.py --python_filename run_cfg_YZ_4Mu_FS_DPS_GENStep_2016UL_Yfirst_Zsecond.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN --fileout file:YZ_4MuFS_DPS_GEN_2016UL_Yfirst_Zsecond.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/YZ_4MuFS_DPS_fragment_Yfirst_Zsecond.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:YZ_4MuFS_DPS_GEN_2016UL_Yfirst_Zsecond.root'),
